...
summary: "Create, edit and delete projects in the experiences section of your Magic Portfolio."
...
You can create, edit and delete projects by adding, modifying or removing `*.mdx` files in the `src/app/experiences/projects` directory.
...
---`,
        language: "tsx",
        label: "src/app/experiences/projects/project-1.mdx"
      }
    ]}
/>
