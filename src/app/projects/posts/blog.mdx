---
title: "Create, edit and delete project posts"
summary: "Create, edit and delete posts in the project section of your Magic Portfolio."
...
You can create, edit and delete posts by adding, modifying or removing `*.mdx` files in the `src/app/projects/posts` directory.
...
---`,
        language: "tsx",
        label: "src/app/projects/posts/post-1.mdx"
      }
    ]}
/>
